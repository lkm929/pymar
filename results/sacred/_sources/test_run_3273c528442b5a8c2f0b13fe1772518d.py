...
from utils.logging import Logger # 內建庫
from utils.timehelper import time_left, time_str # 內建庫
...
from modules.agents import REGISTRY as agent_REGISTRY
  # 应输出包含 "feudal_worker" 和 "feudal_manager"
...
def run_sequential(args, logger):
    ...
    mac = mac_REGISTRY[args.mac](buffer.scheme, groups, args, args.device)
